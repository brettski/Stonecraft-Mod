...
public class BlockStonecraftChest extends BlockContainer
{
    ...
    public BlockStonecraftChest(int par1)
    {
    ...
    public void onBlockPlacedBy(World par1World, int par2, int par3, int par4, EntityLivingBase par5EntityLivingBase, ItemStack par6ItemStack)
    {
        ...
        {
            ((TileEntityStonecraftChest)par1World.getBlockTileEntity(par2, par3, par4)).setChestGuiName(par6ItemStack.getDisplayName());
        }
    }
    ...
    public void onNeighborBlockChange(World par1World, int par2, int par3, int par4, int par5)
    {
        ...
        TileEntityStonecraftChest TileEntityStonecraftChest = (TileEntityStonecraftChest)par1World.getBlockTileEntity(par2, par3, par4);

        if (TileEntityStonecraftChest != null)
        {
            TileEntityStonecraftChest.updateContainingBlockInfo();
        }
    }
    ...
    public void breakBlock(World par1World, int par2, int par3, int par4, int par5, int par6)
    {
        ...
        if (TileEntityStonecraftChest != null)
        {
            for (int j1 = 0; j1 < TileEntityStonecraftChest.getSizeInventory(); ++j1)
            {
                ItemStack itemstack = TileEntityStonecraftChest.getStackInSlot(j1);
    ...
    {
        Object object = (TileEntityStonecraftChest)par1World.getBlockTileEntity(par2, par3, par4);
        ...
        else
        {
            if (par1World.getBlockId(par2 - 1, par3, par4) == this.blockID)
            {
                object = new InventoryLargeChest("container.chestDouble", (TileEntityStonecraftChest)par1World.getBlockTileEntity(par2 - 1, par3, par4), (IInventory)object);
            }

            if (par1World.getBlockId(par2 + 1, par3, par4) == this.blockID)
            {
                object = new InventoryLargeChest("container.chestDouble", (IInventory)object, (TileEntityStonecraftChest)par1World.getBlockTileEntity(par2 + 1, par3, par4));
            }

            if (par1World.getBlockId(par2, par3, par4 - 1) == this.blockID)
            {
                object = new InventoryLargeChest("container.chestDouble", (TileEntityStonecraftChest)par1World.getBlockTileEntity(par2, par3, par4 - 1), (IInventory)object);
            }

            if (par1World.getBlockId(par2, par3, par4 + 1) == this.blockID)
            {
                object = new InventoryLargeChest("container.chestDouble", (IInventory)object, (TileEntityStonecraftChest)par1World.getBlockTileEntity(par2, par3, par4 + 1));
            }
    ...
    {
        TileEntityStonecraftChest TileEntityStonecraftChest = new TileEntityStonecraftChest();
        return TileEntityStonecraftChest;
    }
    ...
    public int isProvidingWeakPower(IBlockAccess par1IBlockAccess, int par2, int par3, int par4, int par5)
    {
        ...
        {
            int i1 = ((TileEntityStonecraftChest)par1IBlockAccess.getBlockTileEntity(par2, par3, par4)).numUsingPlayers;
